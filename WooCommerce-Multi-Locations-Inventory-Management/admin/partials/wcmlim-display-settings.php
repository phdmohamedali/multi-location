    ...
    <div class="tab-content">
        <div id="tab-1" class="tab-pane active">
            <div class="wcmlim_flex_container">
                ...
                <div class="wcmlim_flex_box">
                    <h2><?php _e('Design Preview', 'wcmlim'); ?> </h2>
                    ...
                    <div class="Wcmlim_container wcmlim_product" style="width: 70%;box-sizing: border-box;position: -webkit-sticky; position: sticky;  top: 0;">
