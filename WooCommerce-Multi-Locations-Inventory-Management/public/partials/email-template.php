...
$warehouse_text = esc_html__('Warehouse Received Order','wcmlim');
$hi_text = esc_html__('Hi','wcmlim');
$received_text = esc_html__('Just to let you know — we have received your order ','wcmlim');
$product_text = esc_html__('Product','wcmlim');
$quantity_text = esc_html__('Quantity','wcmlim');
$price_text  = esc_html__('Price','wcmlim');
$Thank_text = esc_html__('Thanks for using','wcmlim');
$payment_method_text = esc_html__('Payment Method','wcmlim');
$total_payment_text = esc_html__('Total Payment','wcmlim');
$shipping_address_text = esc_html__('Shipping address','wcmlim');
$subject = esc_html__('You have received location order','wcmlim');
$message = '<table border="0" cellpadding="0" cellspacing="0" width="600" id="m_7726384717555498504template_container" style="background-color:#ffffff;border:1px solid #dedede;border-radius:3px"><tbody><tr>
										...
										<h1 style="font-family:&quot;Helvetica Neue&quot;,Helvetica,Roboto,Arial,sans-serif;font-size:30px;font-weight:300;line-height:150%;margin:0;text-align:left;color:#ffffff;background-color:inherit">'.$warehouse_text.'</h1></td>
										...
										<p style="margin:0 0 16px"> '.$hi_text.'&nbsp;' . $item_LocName . ',</p><p style="margin:0 0 16px">'.$received_text.' ' . $order_id . ':</p><p style="margin:0 0 16px">Payment Via ' . $payment_method . '.</p>
										...
										<th scope="col" style="color:#636363;border:1px solid #e5e5e5;vertical-align:middle;padding:12px;text-align:left">'.$product_text.'</th>
										<th scope="col" style="color:#636363;border:1px solid #e5e5e5;vertical-align:middle;padding:12px;text-align:left">'.$quantity_text.'</th>
										<th scope="col" style="color:#636363;border:1px solid #e5e5e5;vertical-align:middle;padding:12px;text-align:left">'.$price_text.'</th></tr></thead>										
										<tbody>';								
